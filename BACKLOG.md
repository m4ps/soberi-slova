...
- [x] [CODE]-[012] Реализовать guided target-word loop и переключение displayed target
...
- [x] [CODE]-[015] Адаптировать LevelGenerator к v1.1: 10..15 target-слов и readability-first heuristics
